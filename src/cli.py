...
def build_parser() -> argparse.ArgumentParser:
    ...
    logs_session = logs_subparsers.add_parser("session")
    logs_session.add_argument("session_id")
    logs_session.add_argument("--limit", type=int, default=50)
    logs_chat = logs_subparsers.add_parser("chat")
    logs_chat.add_argument("chat_id", type=int)
    logs_chat.add_argument("--topic-id", dest="topic_id", type=int, default=None)
    logs_chat.add_argument("--limit", type=int, default=50)
